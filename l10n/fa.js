OC.L10N.register(
    ...
    "_visible to group {name} and %n more_::_visible to group {name} and %n more_" : ["برای گروه {name} و بیشتر قابل مشاهده است","برای گروه {name} و بیشتر %nقابل مشاهده است"],
    ", " : ",",
