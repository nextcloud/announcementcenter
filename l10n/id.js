OC.L10N.register(
    ...
    "Announce your maintenance window 🎛️, introduce a new colleague 👤 or make sure everyone knows about the big event next month 📅\n\n🖌️ Markdown support\n\n📑 Comments including @-mentions\n\n👪 Group permissions\n\n⭕ Dashboard integration\n\n⚡ Activities integration\n\n🔔 Notifications integration" : "Umumkan jendela pemeliharaan Anda 🎛️, perkenalkan rekan baru 👤 atau pastikan semua orang mengetahui acara besar bulan depan 📅\n\n🖌️ Dukungan Markdown\n\n📑 Komentar termasuk @-mention\n\n👪 Izin grup\n\n⭕ Integrasi Dasbor\n\n⚡ Integrasi Aktivitas\n\n🔔 Integrasi Notifikasi",
    "Setting changed" : "Pengaturan diubah",
    ...
    "_visible to group {name} and %n more_::_visible to group {name} and %n more_" : ["terlihat untuk grup {name} dan %n lainnya"],
    "scheduled at {time}" : "dijadwalkan pada {time}",
    ", " : ", ",
    "_%n comment_::_%n comments_" : ["%n komentar"],
    "An error occurred while removing the notifications of the announcement" : "Terjadi kesalahan saat menghapus notifikasi pengumuman",
    "An error occurred while deleting the announcement" : "Terjadi kesalahan saat menghapus pengumuman",
    "Clear notifications" : "Bersihkan notifikasi",
    "Delete announcement" : "Hapus pengumuman",
    "An error occurred while posting the announcement" : "Terjadi kesalahan saat memposting pengumuman",
    "New announcement subject" : "Subjek pengumuman baru",
    "Write announcement text, Markdown can be used …" : "Tulis teks pengumuman, Markdown dapat digunakan …",
    "Announce" : "Umumkan",
    ...
    "Schedule announcement time" : "Jadwalkan waktu pengumuman",
    "Schedule deletion time" : "Jadwalkan waktu penghapusan",
