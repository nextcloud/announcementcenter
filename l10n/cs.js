OC.L10N.register(
    ...
    "_visible to group {name} and %n more_::_visible to group {name} and %n more_" : ["viditelné pro skupinu {name} a %n další ","viditelné pro skupinu {name} a %n další","viditelné pro skupinu {name} a %n dalších","viditelné pro skupinu {name} a %n dalších"],
    "_%n comment_::_%n comments_" : ["%n komentář","%n komentáře","%n komentářů","%n komentáře"],
    "New announcement subject" : "Nový předmět oznámení",
