OC.L10N.register(
    ...
    "Delete" : "Видалити",
    "Remove notifications" : "Видалити оповіщення",
    ...
    "This app allows admins to post announcements." : "Цей додаток дозволяє адміністраторам розміщувати оголошення.",
    "This app allows admins to post announcements. Also supports the following features:\n\n⚡ Activities (Requires the activity app to be enabled)\n\n📑 Comments\n\n👪 Group permissions\n\n🔔 Notifications (Requires the notifications app to be enabled)" : "Цей додаток дозволяє адміністраторам розміщувати оголошення. Також підтримуються наступні можливості:\n\n⚡ Дії (Потребує включення дії в додатку)\n\n📑 Коментарі\n\n👪 Дозволи для груп\n\n🔔 Оповіщення (Потребує включення оповіщень в додатку)",
    ...
    "Error occurred while retrieving comment with id {id}" : "Виникла помилка під час отримання коментарю з ідентифікатором {id}"
},
