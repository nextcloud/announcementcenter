OC.L10N.register(
    ...
    "This app allows admins to post announcements. Also supports the following features:\n\n⚡ Activities (Requires the activity app to be enabled)\n\n📑 Comments\n\n👪 Group permissions\n\n🔔 Notifications (Requires the notifications app to be enabled)" : "Dette programmet tillater administrator å legge ut annonseringer. Støtter følgende funksjoner:\n\n⚡ Aktiviteter (Aktivitetsprogram må være aktivitert)\n\n📑 Kommentar\n\n👪 Gruppe tillatelser\n\n🔔 Notifiseringer (notifiseringsprogram må være aktivert)",
