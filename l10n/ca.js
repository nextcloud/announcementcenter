OC.L10N.register(
    ...
    "Error occurred while retrieving comment with ID {id}" : "S'ha produït un error mentre en recuperar el comentari amb l'ID {id}",
    "Error occurred while updating comment with id {id}" : "S'ha produït un error en actualitzar el comentari amb l'ID {id}",
