OC.L10N.register(
    ...
    "_visible to group {name} and %n more_::_visible to group {name} and %n more_" : ["vidno skupini {name1} in še %n drugi","vidno skupini {name1} in še %n drugima","vidno skupini {name1} in še %n drugim","vidno skupini {name1} in še %n drugim"],
