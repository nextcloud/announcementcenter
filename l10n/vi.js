OC.L10N.register(
    ...
    "Clear notifications" : "Xoá thông báo",
    "Delete announcement" : "Xoá thông báo",
    ...
    ", " : ", ",
    "An error occurred while removing the notifications of the announcement" : "Đã xảy ra lỗi khi xoá thông báo từ danh sách",
    "An error occurred while deleting the announcement" : "Đã xảy ra lỗi khi xoá thông báo",
    "_visible to group {name} and %n more_::_visible to group {name} and %n more_" : ["hiển thị với {name} và những %n khác"],
    ...
    "Send emails by default" : "Gửi email mặc định",
