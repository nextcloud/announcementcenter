OC.L10N.register(
    ...
    "You posted an announcement" : "Você fez um anúncio",
    "{actor} posted an announcement" : "{actor} fez um anúncio",
    ...
    "{user} announced “{announcement}”" : "{user} anunciou \"{announcement}\"",
    "Announcement center" : "Central de anúncios",
    ...
    "These groups will be able to post announcements." : "Estes grupos poderão fazer anúncios.",
    ...
    "There are currently no announcements …" : "No momento, não há anúncios …",
    ...
    "scheduled for deletion at {time}" : "agendado para exclusão em {time}",
    ...
    "An error occurred while posting the announcement" : "Ocorreu um erro ao fazer o anúncio",
    "New announcement subject" : "Assunto do novo anúncio",
    "Write announcement text, Markdown can be used …" : "Escreva o texto do anúncio; é possível usar Markdown …",
    "Announce" : "Anunciar",
