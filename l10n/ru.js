OC.L10N.register(
    ...
    "There are currently no announcements …" : "В настоящее время объявлений нет …",
    ...
    "Write announcement text, Markdown can be used …" : "Напишите текст объявления, можно использовать Markdown …",
    "Announce" : "Отправить",
