OC.L10N.register(
    ...
    "Schedule announcement time (optional)" : "Запланируйте время объявления (необязательно)",
    "Schedule deletion time (optional)" : "Запланируйте время удаления (необязательно)",
    "Announce" : "Отправить",
