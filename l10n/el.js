OC.L10N.register(
    ...
    "{user} announced {announcement}" : "{χρήστης} ανακοίνωσε {ανακοίνωση}",
    ...
    "Comments" : "Σχόλια",
    "No comments yet, start the conversation!" : "Δεν υπάρχουν σχόλια ακόμα, ξεκινήστε την συζήτηση!",
    "More comments …" : "Περισσότερα σχόλια …",
    "Save" : "Αποθήκευση",
    "Allowed characters {count} of {max}" : "Επιτρεπόμενοι χαρακτήρες {count} από {max}",
    "Error occurred while retrieving comment with ID {id}" : "Παρουσιάστηκε σφάλμα κατά την ανάκτηση σχολίου με αναγνωριστικό {id}",
